...
import { gray, blue, red, sky, green, amber, pink, indigo, orange, yellow, lime, emerald, teal, cyan, violet, purple, fuchsia, rose, slate, zinc, neutral, stone, } from './color';
import { createBreakpoints } from './create-breakpoint';
import { createSpacingObject } from './create-spacing';
export const THEME_COLORS = ['primary', 'secondary', 'error', 'warning', 'success', 'info'];
const PALETTE = {
    mode: 'light',
    common: {
        black: '#000000',
...
export const createThemeOption = (options) => {
