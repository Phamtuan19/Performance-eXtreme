...
export interface Theme {
    ...
    sxConfig: (options: any, base?: CSSObject) => CSSObject;
...
export interface ThemeOptionsSafe extends DeepOptional<Omit<ThemeOptions, 'breakpoints' | 'unstable_sxConfig' | 'typography'>> {
